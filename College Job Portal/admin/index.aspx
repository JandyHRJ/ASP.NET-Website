...
<div class="container">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 login text-center">
        ...
        <form action="" method="post" class="text-center" runat="server">
            <asp:textbox id="txtUserName" runat="server" cssclass="form-control" placeholder="用户名" data-style="mb:7" >
      </asp:textbox>
            ...
            <asp:textbox id="txtPassword" runat="server" textmode="Password" cssclass="form-control" style="margin-top: 10px;" placeholder="密码" data-style="mb:7" >
       </asp:textbox>
            ...
            <asp:button runat="server" text="登录" Onclick="btnLogin_Click" style="margin-top: 20px;" class="btn btn-primary" />
        </form>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4">
    </div>
